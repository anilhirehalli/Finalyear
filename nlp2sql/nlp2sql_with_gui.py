...
class App:
    def __init__(self, root):
        ...
        self.input_sentence_entry = Entry(self.sentence_frame, textvariable=self.input_sentence_string, width=40)#50
        ...
        self.load_database_button = Button(self.database_frame, text="Check the connection a SQL", command=self.find_sql_file,
                                           width=30)
        ...
        self.load_language_button = Button(self.language_frame, text="Check the a configuration file",
